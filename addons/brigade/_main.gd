...
func _enter_tree():
	...
	add_custom_type("ControllableEntity", "KinematicBody2D", preload("ControllableEntity/main.gd"), preload("ControllableEntity/user-svgrepo-com.svg"))


func _exit_tree():
	remove_custom_type("Ladder")
	remove_custom_type("Entity")
	remove_custom_type("ControllableEntity")
